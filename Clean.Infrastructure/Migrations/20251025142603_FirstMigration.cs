        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewComment = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
                    EmployeeId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_salary_anomalies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_salary_anomalies_employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_salary_histories_employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_vacation_balances_employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagerComment = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_vacation_records", x => x.Id);
                    table.ForeignKey(
                        name: "FK_vacation_records_employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_payroll_records_EmployeeId",
                table: "payroll_records",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_salary_anomalies_EmployeeId",
                table: "salary_anomalies",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_salary_histories_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_vacation_records_EmployeeId",
                table: "vacation_records",
                column: "EmployeeId");
        }
